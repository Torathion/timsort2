...
describe('Lexicographically Sort Subrange of an Ascending ' + 'Array with 3 Random Exchanges', function () {
  lengths.forEach(function (length) {
    it('Should sort a size ' + length + ' array', function () {
      for (var i = 0; i < repetitions; i++) {
        var lo = parseInt(length / 4)
...
describe('Lexicographically Sort Subrange of an Ascending Array ' + 'with 10 Random Elements at Last', function () {
  lengths.forEach(function (length) {
    it('Should sort a size ' + length + ' array', function () {
      for (var i = 0; i < repetitions; i++) {
        var lo = parseInt(length / 4)
